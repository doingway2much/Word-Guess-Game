    ...
    // }
     ...
     window.onload = function() {
        ...
        if(songs[0] === randomSong[0]) {
            ...
            // for (var i = 0; i < song1.title.length; i+lettersInSong+) {
            //     underScore.push ("_");
            //     }
        ...
        if(songs[2] === randomSong[0]) {
            underScore = [];
            var song3Selected = document.getElementById("game");
            song3Selected.textContent = "Here's yoru first hint: " + [song3.fact1];
        ...
        if(songs[3] === randomSong[0]) {
            underScore = [];
             var song4Selected = document.getElementById("game");
             song4Selected.textContent = "Here's yoru first hint: " + [song4.fact1];
        ...
        if(songs[4] === randomSong[0]) {
            underScore = [];
            var song5Selected = document.getElementById("game");
            song5Selected.textContent = "Here's yoru first hint: " + [song5.fact1];
